...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, La/l/a/b0;-><init>()V

    return-void
.end method

.method public static v(La/r/i;)Z
    .locals 1

    .line 1
    iget-object p0, p0, La/r/i;->f:Ljava/util/ArrayList;

    .line 2
    invoke-static {p0}, La/l/a/b0;->k(Ljava/util/List;)Z
...
.method public a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-virtual {p1, p2}, La/r/i;->b(Landroid/view/View;)La/r/i;
...
.method public b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    :cond_0
    instance-of v0, p1, La/r/o;

    const/4 v1, 0x0

    if-eqz v0, :cond_1

    check-cast p1, La/r/o;

    .line 1
    iget-object v0, p1, La/r/o;->y:Ljava/util/ArrayList;
    ...
    .line 2
    invoke-virtual {p1, v1}, La/r/o;->I(I)La/r/i;
    ...
    :cond_1
    invoke-static {p1}, La/r/d;->v(La/r/i;)Z
    ...
    .line 3
    iget-object v0, p1, La/r/i;->g:Ljava/util/ArrayList;

    .line 4
    invoke-static {v0}, La/l/a/b0;->k(Ljava/util/List;)Z
    ...
    invoke-virtual {p1, v2}, La/r/i;->b(Landroid/view/View;)La/r/i;
...
.method public c(Landroid/view/ViewGroup;Ljava/lang/Object;)V
    ...
    check-cast p2, La/r/i;

    .line 1
    sget-object v0, La/r/m;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p2}, La/r/i;->j()La/r/i;
    ...
    invoke-virtual {p2, p1, v0}, La/r/i;->h(Landroid/view/ViewGroup;Z)V
    ...
    .line 9
    new-instance v0, La/r/m$a;

    invoke-direct {v0, p2, p1}, La/r/m$a;-><init>(La/r/i;Landroid/view/ViewGroup;)V
...
.method public g(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, La/r/i;->j()La/r/i;
...
.method public l(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v0, La/r/o;

    invoke-direct {v0}, La/r/o;-><init>()V

    if-eqz p1, :cond_0

    check-cast p1, La/r/i;

    invoke-virtual {v0, p1}, La/r/o;->H(La/r/i;)La/r/o;
    ...
    invoke-virtual {v0, p2}, La/r/o;->H(La/r/i;)La/r/o;

    :cond_1
    if-eqz p3, :cond_2

    check-cast p3, La/r/i;

    invoke-virtual {v0, p3}, La/r/o;->H(La/r/i;)La/r/o;
...
.method public m(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-virtual {p1, p2}, La/r/i;->w(Landroid/view/View;)La/r/i;
...
.method public n(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p1, v0}, La/r/i;->w(Landroid/view/View;)La/r/i;
...
.method public o(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p1, v0}, La/r/i;->a(La/r/i$d;)La/r/i;
...
.method public p(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v9}, La/r/i;->a(La/r/i$d;)La/r/i;
...
.method public q(Ljava/lang/Object;Landroid/graphics/Rect;)V
    ...
    new-instance v0, La/r/d$d;

    invoke-direct {v0, p0, p2}, La/r/d$d;-><init>(La/r/d;Landroid/graphics/Rect;)V
...
.method public r(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p2, v0}, La/l/a/b0;->j(Landroid/view/View;Landroid/graphics/Rect;)V

    new-instance p2, La/r/d$a;

    invoke-direct {p2, p0, v0}, La/r/d$a;-><init>(La/r/d;Landroid/graphics/Rect;)V

    invoke-virtual {p1, p2}, La/r/i;->A(La/r/i$c;)V
...
.method public s(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    invoke-static {v0, v3}, La/l/a/b0;->d(Ljava/util/List;Landroid/view/View;)V
