...
# instance fields
.field public b:La/b/g/i/g;

.field public c:La/b/g/i/i;
...
.method public c(La/b/g/i/g;La/b/g/i/i;)Z
    ...
    invoke-virtual {p2}, La/b/g/i/i;->getActionView()Landroid/view/View;

    move-result-object v0

    iput-object v0, p1, Landroidx/appcompat/widget/Toolbar;->j:Landroid/view/View;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->c:La/b/g/i/i;
    ...
    .line 3
    iput-boolean p1, p2, La/b/g/i/i;->C:Z

    iget-object p2, p2, La/b/g/i/i;->n:La/b/g/i/g;

    const/4 v0, 0x0

    invoke-virtual {p2, v0}, La/b/g/i/g;->q(Z)V
    ...
    instance-of v0, p2, La/b/g/b;

    if-eqz v0, :cond_6

    check-cast p2, La/b/g/b;

    invoke-interface {p2}, La/b/g/b;->a()V
...
.method public h(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->c:La/b/g/i/i;

    if-eqz p1, :cond_2

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->b:La/b/g/i/g;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->b:La/b/g/i/g;

    invoke-virtual {v2, v1}, La/b/g/i/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->c:La/b/g/i/i;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->c:La/b/g/i/i;

    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$d;->k(La/b/g/i/g;La/b/g/i/i;)Z
...
.method public j(Landroid/content/Context;La/b/g/i/g;)V
    ...
    invoke-virtual {p1, v0}, La/b/g/i/g;->d(La/b/g/i/i;)Z

    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->b:La/b/g/i/g;
...
.method public k(La/b/g/i/g;La/b/g/i/i;)Z
    ...
    instance-of v0, p1, La/b/g/b;

    if-eqz v0, :cond_0

    check-cast p1, La/b/g/b;

    invoke-interface {p1}, La/b/g/b;->e()V
    ...
    .line 2
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->c:La/b/g/i/i;
    ...
    invoke-virtual {p2, p1}, La/b/g/i/g;->q(Z)V
