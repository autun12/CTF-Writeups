...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    return (i > 0) ? constrain(f1 * paramFloat3, paramFloat2, paramFloat1) : -constrain(-f1 * paramFloat3, paramFloat2, paramFloat1);
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent) {
    ...
    //   109: fstore #7
    //   111: aload_0
    //   112: getfield mScroller : Landroidx/core/widget/AutoScrollHelper$ClampedScroller;
    //   115: fload #6
    //   117: fload #7
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/core/widget/AutoScrollHelper.class
