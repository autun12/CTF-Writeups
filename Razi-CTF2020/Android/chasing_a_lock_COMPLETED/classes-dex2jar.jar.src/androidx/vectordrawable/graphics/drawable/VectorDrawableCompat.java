...
public class VectorDrawableCompat extends VectorDrawableCommon {
  ...
  private void updateStateFromTypedArray(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser, Resources.Theme paramTheme) throws XmlPullParserException {
    String str;
    VectorDrawableCompatState vectorDrawableCompatState = this.mVectorState;
    VPathRenderer vPathRenderer = vectorDrawableCompatState.mVPathRenderer;
  ...
  public void inflate(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme) throws XmlPullParserException, IOException {
    ...
    updateStateFromTypedArray(typedArray, paramXmlPullParser, paramTheme);
    typedArray.recycle();
  ...
  private static class VClipPath extends VPath {
    ...
    private void updateStateFromTypedArray(TypedArray param1TypedArray, XmlPullParser param1XmlPullParser) {
      ...
      this.mFillRule = TypedArrayUtils.getNamedInt(param1TypedArray, param1XmlPullParser, "fillType", 2, 0);
    }
    ...
    private void drawPath(VectorDrawableCompat.VGroup param1VGroup, VectorDrawableCompat.VPath param1VPath, Canvas param1Canvas, int param1Int1, int param1Int2, ColorFilter param1ColorFilter) {
      ...
      if (param1VPath.isClipPath()) {
        ...
        if (((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathStart != 0.0F || ((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathEnd != 1.0F) {
          ...
          path2.reset();
          if (f5 > f6) {
            this.mPathMeasure.getSegment(f5, f1, path2, true);
            this.mPathMeasure.getSegment(0.0F, f6, path2, true);
          } else {
            this.mPathMeasure.getSegment(f5, f6, path2, true);
          } 
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/vectordrawable/graphics/drawable/VectorDrawableCompat.class
