...
public final class ArraySet<E> implements Collection<E>, Set<E> {
  ...
  public boolean add(E paramE) {
    ...
    if (k < m) {
      ...
      Object[] arrayOfObject = this.mArray;
      System.arraycopy(arrayOfObject, k, arrayOfObject, i, this.mSize - k);
    } 
    this.mHashes[k] = j;
  ...
  public E removeAt(int paramInt) {
    ...
    if (i <= 1) {
      ...
      if (j > 8 && i < arrayOfInt.length / 3) {
        ...
        if (paramInt < i) {
          k = paramInt + 1;
          System.arraycopy(arrayOfInt1, k, this.mHashes, paramInt, i - paramInt);
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/collection/ArraySet.class
