      ...
      if (n > 8 && j < arrayOfInt.length / 3) {
        ...
        if (j == this.mSize) {
          ...
          if (paramInt < m) {
            ...
            n = m - paramInt;
            System.arraycopy(arrayOfInt1, k, arrayOfInt, paramInt, n);
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/collection/SimpleArrayMap.class
