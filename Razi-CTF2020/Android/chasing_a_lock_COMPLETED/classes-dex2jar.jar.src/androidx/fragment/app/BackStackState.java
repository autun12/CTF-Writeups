...
final class BackStackState implements Parcelable {
  ...
  public BackStackRecord instantiate(FragmentManagerImpl paramFragmentManagerImpl) {
    ...
    while (i < this.mOps.length) {
      ...
      j = i + 1;
      op.mExitAnim = arrayOfInt1[i];
      i = j + 1;
      op.mPopEnterAnim = arrayOfInt1[j];
      op.mPopExitAnim = arrayOfInt1[i];
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/fragment/app/BackStackState.class
