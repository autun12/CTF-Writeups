...
class AlertController {
  ...
  private void setupButtons(ViewGroup paramViewGroup) {
    ...
    if (TextUtils.isEmpty(this.mButtonNeutralText) && this.mButtonNeutralIcon == null) {
      ...
      Drawable drawable = this.mButtonNeutralIcon;
      if (drawable != null) {
        int j = this.mButtonIconDimen;
        drawable.setBounds(0, 0, j, j);
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/appcompat/app/AlertController.class
