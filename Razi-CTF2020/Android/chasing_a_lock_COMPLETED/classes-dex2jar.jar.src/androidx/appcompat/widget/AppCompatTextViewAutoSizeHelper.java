...
class AppCompatTextViewAutoSizeHelper {
  ...
  private static Field getTextViewField(String paramString) {
    try {
      Field field1 = sTextViewFieldByNameCache.get(paramString);
      Field field2 = field1;
      if (field1 == null) {
        ...
        if (field1 != null) {
          ...
          sTextViewFieldByNameCache.put(paramString, field1);
          field2 = field1;
        } 
      } 
      return field2;
  ...
  private boolean suggestedSizeFitsInSpace(int paramInt, RectF paramRectF) {
    ...
    StaticLayout staticLayout = createLayout(charSequence2, invokeAndReturnWithDefault(this.mTextView, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL), Math.round(paramRectF.right), b);
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/appcompat/widget/AppCompatTextViewAutoSizeHelper.class
