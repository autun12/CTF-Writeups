...
public class AlertDialogLayout extends LinearLayoutCompat {
  ...
  private boolean tryOnMeasure(int paramInt1, int paramInt2) {
    ...
    for (i4 = 0; i2 < i; i4 = n) {
      ...
      n = i4;
      if (view2.getVisibility() != 8)
        n = Math.max(i4, view2.getMeasuredWidth()); 
      i2++;
    } 
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/appcompat/widget/AlertDialogLayout.class
