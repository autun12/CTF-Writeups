...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
  ...
  private static class PreQAutoCompleteTextViewReflector {
    ...
    PreQAutoCompleteTextViewReflector() {
      ...
      try {
        this.mEnsureImeVisible = AutoCompleteTextView.class.getMethod("ensureImeVisible", new Class[] { boolean.class });
  ...
  private static class UpdatableTouchDelegate extends TouchDelegate {
    ...
    public boolean onTouchEvent(MotionEvent param1MotionEvent) {
      ...
      //   65: goto -> 151
      //   68: aload_0
      //   69: getfield mDelegateTargeted : Z
      //   72: istore #8
      //   74: iload #8
      //   76: istore #7
      //   78: iload #5
      ...
      //   93: istore #4
      //   95: aload_0
      //   96: getfield mSlopBounds : Landroid/graphics/Rect;
      //   99: iload_2
      //   100: iload_3
      //   101: invokevirtual contains : (II)Z
      //   104: ifne -> 151
      //   107: iconst_0
      //   108: istore #4
      //   110: iload #8
      ...
      //   121: iload_2
      //   122: iload_3
      //   123: invokevirtual contains : (II)Z
      //   126: ifeq -> 144
      //   129: aload_0
      //   130: iconst_1
      //   131: putfield mDelegateTargeted : Z
      //   134: iconst_1
      //   135: istore #7
      //   137: iload #5
      //   139: istore #4
      ...
      //   158: ifeq -> 200
      //   161: aload_0
      //   162: getfield mActualBounds : Landroid/graphics/Rect;
      //   165: iload_2
      //   166: iload_3
      //   167: invokevirtual contains : (II)Z
      //   170: ifne -> 200
      //   173: aload_1
      //   174: aload_0
      ...
      //   183: i2f
      //   184: aload_0
      //   185: getfield mDelegateView : Landroid/view/View;
      //   188: invokevirtual getHeight : ()I
      //   191: iconst_2
      //   192: idiv
      //   193: i2f
      //   194: invokevirtual setLocation : (FF)V
      //   197: goto -> 224
      //   200: aload_1
      //   201: iload_2
      //   202: aload_0
      ...
      //   219: isub
      //   220: i2f
      //   221: invokevirtual setLocation : (FF)V
      //   224: aload_0
      //   225: getfield mDelegateView : Landroid/view/View;
      //   228: aload_1
      //   229: invokevirtual dispatchTouchEvent : (Landroid/view/MotionEvent;)Z
      //   232: istore #6
      //   234: iload #6
      //   236: ireturn
    }
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/appcompat/widget/SearchView.class
