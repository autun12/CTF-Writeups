...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
  ...
  public WindowInsets onApplyWindowInsets(WindowInsets paramWindowInsets) {
    ...
    boolean bool = applyInsets((View)this.mActionBarTop, rect, true, true, false, true);
    ViewCompat.computeSystemWindowInsets((View)this, windowInsetsCompat, this.mBaseContentInsets);
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    if (!this.mOverlayMode && !m) {
      ...
      Insets insets = Insets.of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + i1, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0);
    ...
    int n = Math.max(j, this.mContent.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
    int m = View.combineMeasuredStates(k, this.mContent.getMeasuredState());
    j = getPaddingLeft();
    k = getPaddingRight();
    n = Math.max(n + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight());
    setMeasuredDimension(View.resolveSizeAndState(Math.max(i1 + j + k, getSuggestedMinimumWidth()), paramInt1, m), View.resolveSizeAndState(n, paramInt2, m << 16));
  }
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/appcompat/widget/ActionBarOverlayLayout.class
