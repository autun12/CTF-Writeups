...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView {
  ...
  public void setCompoundDrawablesRelativeWithIntrinsicBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (paramInt1 != 0) {
      drawable2 = AppCompatResources.getDrawable(context, paramInt1);
    } else {
      drawable2 = null;
    } 
    if (paramInt2 != 0) {
      drawable3 = AppCompatResources.getDrawable(context, paramInt2);
    } else {
      drawable3 = null;
    } 
    if (paramInt3 != 0) {
      drawable4 = AppCompatResources.getDrawable(context, paramInt3);
    } else {
      drawable4 = null;
    } 
    if (paramInt4 != 0)
      drawable1 = AppCompatResources.getDrawable(context, paramInt4); 
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/appcompat/widget/AppCompatTextView.class
