...
public class Toolbar extends ViewGroup {
  ...
  public Toolbar(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    ensureContentInsets();
    this.mContentInsets.setAbsolute(k, paramInt);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (shouldLayout((View)this.mCollapseButtonView))
      if (i) {
        paramInt2 = layoutChildRight((View)this.mCollapseButtonView, i4, arrayOfInt, paramInt4);
        paramInt1 = paramInt3;
      } else {
    ...
    if (bool || paramBoolean) {
        ...
        if (i3 != 80) {
          ...
          if (i3 < layoutParams1.topMargin + this.mTitleMarginTop) {
            ...
            if (k < layoutParams1.bottomMargin + this.mTitleMarginBottom)
              paramInt1 = Math.max(0, i3 - layoutParams2.bottomMargin + this.mTitleMarginBottom - k); 
          } 
      ...
      if (i) {
        ...
        if (paramBoolean) {
          ...
          this.mSubtitleTextView.layout(paramInt2 - i3, i1, paramInt2, i + i1);
        ...
        if (paramBoolean) {
          ...
          this.mSubtitleTextView.layout(paramInt3, paramInt1, i1, i3 + paramInt1);
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/appcompat/widget/Toolbar.class
