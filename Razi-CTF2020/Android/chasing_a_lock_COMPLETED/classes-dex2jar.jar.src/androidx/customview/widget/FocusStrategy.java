...
class FocusStrategy {
  private static boolean beamBeats(int paramInt, Rect paramRect1, Rect paramRect2, Rect paramRect3) {
    ...
    if (beamsOverlap(paramInt, paramRect1, paramRect3) || !bool)
      return false; 
    bool = isToDirectionOf(paramInt, paramRect1, paramRect3);
    boolean bool1 = true;
    if (!bool)
      return true; 
    bool = bool1;
    if (paramInt != 17)
      if (paramInt == 66) {
        bool = bool1;
      } else if (majorAxisDistance(paramInt, paramRect1, paramRect2) < majorAxisDistanceToFarEdge(paramInt, paramRect1, paramRect3)) {
        bool = bool1;
      } else {
        bool = false;
      }  
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/customview/widget/FocusStrategy.class
