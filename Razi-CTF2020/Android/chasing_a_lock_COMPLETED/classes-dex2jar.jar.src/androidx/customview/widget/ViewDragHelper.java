...
public class ViewDragHelper {
  ...
  public boolean continueSettling(boolean paramBoolean) {
    ...
    if (i == 2) {
      ...
      int k = j - this.mCapturedView.getLeft();
      ...
      if (k != 0 || m != 0)
        this.mCallback.onViewPositionChanged(this.mCapturedView, j, i, k, m); 
      boolean bool2 = bool1;
      if (bool1) {
        bool2 = bool1;
  ...
  public boolean shouldInterceptTouchEvent(MotionEvent paramMotionEvent) {
    ...
    //   140: ifeq -> 70
    //   143: aload_0
    //   144: getfield mCallback : Landroidx/customview/widget/ViewDragHelper$Callback;
    //   147: iload_3
    //   148: iload #6
    //   150: iand
    //   151: iload_2
    ...
    //   331: istore #12
    //   333: aload_0
    //   334: getfield mCallback : Landroidx/customview/widget/ViewDragHelper$Callback;
    //   337: aload #10
    //   339: iload #11
    //   341: iload #12
    //   343: iadd
    ...
    //   361: istore #14
    //   363: aload_0
    //   364: getfield mCallback : Landroidx/customview/widget/ViewDragHelper$Callback;
    //   367: aload #10
    //   369: iload #12
    //   371: iload #14
    //   373: iadd
    ...
    //   379: istore #14
    //   381: aload_0
    //   382: getfield mCallback : Landroidx/customview/widget/ViewDragHelper$Callback;
    //   385: aload #10
    //   387: invokevirtual getViewHorizontalDragRange : (Landroid/view/View;)I
    //   390: istore #15
    //   392: aload_0
    //   393: getfield mCallback : Landroidx/customview/widget/ViewDragHelper$Callback;
    //   396: aload #10
    ...
    //   578: ifeq -> 593
    //   581: aload_0
    //   582: getfield mCallback : Landroidx/customview/widget/ViewDragHelper$Callback;
    //   585: iload #6
    //   587: iload_2
    //   588: iand
    //   589: iload_3
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/customview/widget/ViewDragHelper.class
