...
public class PagerTitleStrip extends ViewGroup {
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    i10 = Math.max(Math.max(i9 + i6, i8 + j), i10 + i7);
    ...
    i4 = Math.max(n - i3 - k, i5 + this.mScaledTextSpacing);
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/viewpager/widget/PagerTitleStrip.class
