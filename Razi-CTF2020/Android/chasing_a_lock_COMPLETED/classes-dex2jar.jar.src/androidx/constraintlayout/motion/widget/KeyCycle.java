    ...
    for (String str : paramHashMap.keySet()) {
      ...
      switch (b) {
        default:
          ...
          Log.v("WARNING KeyCycle", stringBuilder1.toString());
          continue;
        case 12:
  ...
  public float getValue(String paramString) {
    ...
    switch (b) {
      default:
        ...
        Log.v("WARNING! KeyCycle", stringBuilder.toString());
        return Float.NaN;
      case 12:
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/motion/widget/KeyCycle.class
