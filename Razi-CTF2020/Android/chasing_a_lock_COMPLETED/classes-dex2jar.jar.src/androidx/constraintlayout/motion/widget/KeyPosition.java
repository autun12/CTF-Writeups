...
public class KeyPosition extends KeyPositionBase {
  ...
  private void calcCartesianPosition(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4) {
    ...
    this.mCalculatedPositionX = (int)(paramFloat1 + paramFloat3 * f1 + f3 * f2);
    this.mCalculatedPositionY = (int)(paramFloat2 + f1 * paramFloat4 + f2 * f4);
  }
  ...
  void positionPathAttributes(RectF paramRectF1, RectF paramRectF2, float paramFloat1, float paramFloat2, String[] paramArrayOfString, float[] paramArrayOffloat) {
    ...
    paramFloat2 = (f3 * f1 + f5 * paramFloat2) / f4;
    if (paramArrayOfString[0] != null) {
      if ("percentX".equals(paramArrayOfString[0])) {
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/motion/widget/KeyPosition.class
