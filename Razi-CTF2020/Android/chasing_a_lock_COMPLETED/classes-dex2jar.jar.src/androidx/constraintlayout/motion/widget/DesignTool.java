...
public class DesignTool implements ProxyInterface {
  ...
  static {
    HashMap<Pair<Integer, Integer>, String> hashMap1 = allAttributes;
    Integer integer2 = Integer.valueOf(4);
    hashMap1.put(Pair.create(integer2, integer2), "layout_constraintBottom_toBottomOf");
    hashMap1 = allAttributes;
    Integer integer3 = Integer.valueOf(3);
    hashMap1.put(Pair.create(integer2, integer3), "layout_constraintBottom_toTopOf");
    allAttributes.put(Pair.create(integer3, integer2), "layout_constraintTop_toBottomOf");
    allAttributes.put(Pair.create(integer3, integer3), "layout_constraintTop_toTopOf");
    hashMap1 = allAttributes;
    integer2 = Integer.valueOf(6);
    hashMap1.put(Pair.create(integer2, integer2), "layout_constraintStart_toStartOf");
    hashMap1 = allAttributes;
    integer3 = Integer.valueOf(7);
    hashMap1.put(Pair.create(integer2, integer3), "layout_constraintStart_toEndOf");
    allAttributes.put(Pair.create(integer3, integer2), "layout_constraintEnd_toStartOf");
    allAttributes.put(Pair.create(integer3, integer3), "layout_constraintEnd_toEndOf");
    hashMap1 = allAttributes;
    integer2 = Integer.valueOf(1);
    hashMap1.put(Pair.create(integer2, integer2), "layout_constraintLeft_toLeftOf");
    HashMap<Pair<Integer, Integer>, String> hashMap2 = allAttributes;
    Integer integer1 = Integer.valueOf(2);
    hashMap2.put(Pair.create(integer2, integer1), "layout_constraintLeft_toRightOf");
    allAttributes.put(Pair.create(integer1, integer1), "layout_constraintRight_toRightOf");
    allAttributes.put(Pair.create(integer1, integer2), "layout_constraintRight_toLeftOf");
  ...
  private static void Connect(int paramInt1, ConstraintSet paramConstraintSet, View paramView, HashMap<String, String> paramHashMap, int paramInt2, int paramInt3) {
    String str1 = allAttributes.get(Pair.create(Integer.valueOf(paramInt2), Integer.valueOf(paramInt3)));
    String str2 = paramHashMap.get(str1);
    if (str2 != null) {
      str1 = allMargins.get(str1);
      if (str1 != null) {
        paramInt1 = GetPxFromDp(paramInt1, paramHashMap.get(str1));
      } else {
        paramInt1 = 0;
      } 
  ...
  public Boolean getPositionKeyframe(Object<View, MotionController> paramObject1, Object paramObject2, float paramFloat1, float paramFloat2, String[] paramArrayOfString, float[] paramArrayOffloat) {
    if (paramObject1 instanceof KeyPositionBase) {
      KeyPositionBase keyPositionBase = (KeyPositionBase)paramObject1;
      paramObject1 = (Object<View, MotionController>)this.mMotionLayout.mFrameArrayList;
      paramObject2 = paramObject2;
      ((MotionController)paramObject1.get(paramObject2)).positionKeyframe((View)paramObject2, keyPositionBase, paramFloat1, paramFloat2, paramArrayOfString, paramArrayOffloat);
  ...
  public void setKeyFrame(Object paramObject1, int paramInt, String paramString, Object paramObject2) {
    if (this.mMotionLayout.mScene != null) {
      ...
      ((MotionLayout)paramObject1).mTransitionGoalPosition = paramInt / 100.0F;
      ((MotionLayout)paramObject1).mTransitionLastPosition = 0.0F;
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/motion/widget/DesignTool.class
