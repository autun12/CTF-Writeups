...
public class Easing {
  ...
  static class CubicEasing extends Easing {
    ...
    CubicEasing(String param1String) {
      ...
      this.y1 = Double.parseDouble(param1String.substring(j, i).trim());
    ...
    private double getDiffX(double param1Double) {
      ...
      double d2 = this.x1;
      double d3 = this.x2;
      return d1 * 3.0D * d1 * d2 + d1 * 6.0D * param1Double * (d3 - d2) + 3.0D * param1Double * param1Double * (1.0D - d3);
    }
    ...
    private double getY(double param1Double) {
      double d1 = 1.0D - param1Double;
      double d2 = 3.0D * d1;
      return this.y1 * d1 * d2 * param1Double + this.y2 * d2 * param1Double * param1Double + param1Double * param1Double * param1Double;
    }
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/motion/utils/Easing.class
