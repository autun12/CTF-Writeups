...
public class ConstraintSet {
  ...
  private static String[] splitString(String paramString) {
    ...
    byte b2 = 0;
    int i;
    for (i = 0; b1 < arrayOfChar.length; i = j) {
      byte b;
      int j;
      if (arrayOfChar[b1] == ',' && !i) {
  ...
  public void dump(MotionScene paramMotionScene, int... paramVarArgs) {
    Set<Integer> set1;
    Set<Integer> set2 = this.mConstraints.keySet();
    ...
    if (i != 0) {
      ...
      for (i = 0; i < k; i++)
        set2.add(Integer.valueOf(paramVarArgs[i])); 
      set1 = set2;
    } else {
      set1 = new HashSet<Integer>(set2);
    } 
    PrintStream printStream = System.out;
    StringBuilder stringBuilder = new StringBuilder();
    stringBuilder.append(set1.size());
    stringBuilder.append(" constraints");
    printStream.println(stringBuilder.toString());
    stringBuilder = new StringBuilder();
    Integer[] arrayOfInteger = set1.<Integer>toArray(new Integer[0]);
        ...
        if (i != 0) {
          if (i != 2) {
            ...
            switch (i) {
              ...
              case 5:
                if (constraint != null) {
                  constraint.layout.fillFromAttributeList((Context)stringBuilder1, Xml.asAttributeSet(paramXmlPullParser));
                  Constraint constraint3 = constraint;
                  break;
                } 
                runtimeException3 = new RuntimeException();
              ...
              case 4:
                if (constraint != null) {
                  constraint.transform.fillFromAttributeList((Context)stringBuilder1, Xml.asAttributeSet(paramXmlPullParser));
                  Constraint constraint3 = constraint;
                  break;
                } 
              ...
              case 3:
                if (constraint != null) {
                  constraint.propertySet.fillFromAttributeList((Context)runtimeException1, Xml.asAttributeSet(paramXmlPullParser));
                  Constraint constraint3 = constraint;
                  break;
                } 
                runtimeException1 = new RuntimeException();
          ...
          try {
            ...
            if (clazz == clazz1) {
              ...
              if (object2.intValue() != -1) {
                str1 = param1MotionScene.lookUpConstraintName(object2.intValue());
                param1StringBuilder.append("    ");
                ...
                if (str1 == null)
                  object1 = object2; 
                param1StringBuilder.append(object1);
                param1StringBuilder.append("\"\n");
              } 
            } else if (str1 == float.class) {
              object2 = object2;
              if (object2.floatValue() != -1.0F) {
                param1StringBuilder.append("    ");
                param1StringBuilder.append((String)object1);
                param1StringBuilder.append(" = \"");
                param1StringBuilder.append(object2);
                param1StringBuilder.append("\"\n");
              } 
            } 
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/widget/ConstraintSet.class
