      ...
      for (byte b = 0; b < i; b++) {
        ...
        if (j == R.styleable.State_android_id) {
          ...
          if ("layout".equals(str)) {
            ...
            this.mConstraintSet.clone(param1Context, this.mConstraintID);
          } 
        } 
      } 
      typedArray.recycle();
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/widget/ConstraintLayoutStates.class
