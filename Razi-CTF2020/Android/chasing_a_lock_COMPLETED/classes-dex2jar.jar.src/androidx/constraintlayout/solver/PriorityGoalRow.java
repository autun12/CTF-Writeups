...
public class PriorityGoalRow extends ArrayRow {
  ...
  private final void addToGoal(SolverVariable paramSolverVariable) {
    ...
    if (i + 1 > arrayOfSolverVariable.length) {
      this.arrayGoals = Arrays.<SolverVariable>copyOf(arrayOfSolverVariable, arrayOfSolverVariable.length * 2);
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/solver/PriorityGoalRow.class
