    ...
    if (this.dimension.resolved && this.widget.measured) {
      ...
      if ((this.widget.mListAnchors[2]).mTarget != null && (this.widget.mListAnchors[3]).mTarget != null) {
        if (this.widget.isInVerticalChain()) {
          ...
          DependencyNode dependencyNode2 = getTarget(this.widget.mListAnchors[2]);
          DependencyNode dependencyNode1 = getTarget(this.widget.mListAnchors[3]);
          ...
          if (i != -1) {
            if (i != 0) {
              if (i != 1) {
                ...
                float f1 = this.widget.horizontalRun.dimension.value;
                float f2 = this.widget.getDimensionRatio();
                f2 = f1 / f2;
              } 
            } else {
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/solver/widgets/analyzer/VerticalWidgetRun.class
