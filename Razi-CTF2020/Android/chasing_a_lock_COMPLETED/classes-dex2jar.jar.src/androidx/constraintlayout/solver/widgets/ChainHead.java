  ...
  private void defineChainProperties() {
    ...
    while (!bool2) {
      ...
      if (constraintWidget1.getVisibility() != 8) {
        ...
        this.mTotalSize += constraintWidget1.mListAnchors[i].getMargin();
        int k = this.mTotalSize;
        ...
        this.mTotalMargins += constraintWidget1.mListAnchors[i].getMargin();
        this.mTotalMargins += constraintWidget1.mListAnchors[j].getMargin();
...
/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/solver/widgets/ChainHead.class
