...
public class Dimension {
  ...
  public enum Type {
    ...
    static {
      MATCH_CONSTRAINT = new Type("MATCH_CONSTRAINT", 3);
      $VALUES = new Type[] { FIXED, WRAP, MATCH_PARENT, MATCH_CONSTRAINT };
    }
  }
}


/* Location:              /home/austin/Documents/CTFFolder/CTF-Writeups/Razi-CTF2020/Android/chasing_a_lock/chasing a lock/classes-dex2jar.jar!/androidx/constraintlayout/solver/state/Dimension.class
